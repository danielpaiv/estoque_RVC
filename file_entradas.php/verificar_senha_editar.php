...
if (!$usuario) {
  echo "<script>alert('Usuário não encontrado.'); window.location.href='listar_entradas.php';</script>";
  exit;
}
...
if (!$senhaOK) {
  echo "<script>alert('Senha incorreta! Edição cancelada.'); window.location.href='listar_entradas.php';</script>";
  exit;
}

// Se a senha estiver correta, redireciona para editar_entradas.php
header("Location: editar_entradas.php?id=$id");
exit;
?>
