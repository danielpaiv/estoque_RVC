...
if (!$usuario) {
  echo "<script>alert('Usuário não encontrado.'); window.location.href='listar_estoque.php';</script>";
  exit;
}
...
if (!$senhaOK) {
  echo "<script>alert('Senha incorreta! Edição cancelada.'); window.location.href='listar_estoque.php';</script>";
  exit;
}

// Se a senha estiver correta, redireciona para editar_estoque.php
header("Location: editar_estoque.php?id=$id");
exit;
?>
