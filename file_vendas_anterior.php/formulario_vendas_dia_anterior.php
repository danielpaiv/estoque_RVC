...
<head>
    ...
    <title>VENDAS DIA ANTERIOR - RVC</title>
</head>
  <style>
    body {
    ...
    <body>
     ...
     <!--<button onclick="window.location.href='http://localhost/controle_combustivel/estoque_RVC/file_estoque/formulario_estoque.php'">Adicionar Estoque </button>-->
